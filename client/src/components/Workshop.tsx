...
export function Workshop() {
  return (
    <section id="oficina" className="relative py-24 md:py-28 bg-[var(--paper-green)] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            <h2 className="lg:col-span-7 font-display text-[2.2rem] leading-[1.1] sm:text-[3rem] font-semibold text-[var(--foreground)]">
              Da nossa oficina para a <span className="text-[var(--emerald-deep)]">sua obra</span>
            </h2>
            <p className="lg:col-span-5 text-[1rem] text-[oklch(0.38_0.018_150)] font-light leading-relaxed">
